...
Identify the player who made the set associated with each attack (noting that some files might not have this coded for all attacks, or even coded at all):
